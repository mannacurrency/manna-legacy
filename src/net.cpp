...
{
    // Wait for IRC to get it first - disabled with manna
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Manna " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are manna dns seeds.
...
void ThreadDNSAddressSeed2(void* parg)
{
    ...
    if (true /*!fTestNet*/)  // manna enables dns seeding with testnet too
    {
...
unsigned int pnSeed[] =
{
    0xde84f1c0, 0x1693b992, 0x4031eb6d, 0x4d3463d1, 0x586a6854, 0x5da9ae65,
...
bool BindListenPort(string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, sizeof(sockaddr)) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to port %d on this computer.  Manna is probably already running."), ntohs(sockaddr.sin_port));
        else
